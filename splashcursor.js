/**
 * SplashCursor Component (Vanilla JS implementation from React Bits)
 * High-performance WebGL Fluid Simulation Cursor with light blue theme
 */
(function initSplashCursor() {
  function createCursorCanvas() {
    let container = document.getElementById('splashCursorContainer');
    if (!container) {
  ...
  function runSplashCursor() {
    ...
    if (!gl) return; // Gracefully fallback if WebGL isn't available
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', runSplashCursor);
  } else {
    runSplashCursor();
  }
})();
